# KION - Sistema de Punto de Venta e Inventario Veterinario
...
* **Frontend:** HTML5, CSS3, JavaScript (Soporte bilingüe ES/EN).
* **Backend:** PHP 8.x.
* **Base de Datos:** MySQL / MariaDB (Administrado vía phpMyAdmin).
* **Infraestructura:** Despliegue en servidor en la nube (IONOS) con dominio `.mx`.
